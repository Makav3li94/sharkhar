                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="card">
                     ...
                     <span class="label onsale">تایید نشده</span>
                            ...
                            <div class="product_details pt-0 mt-0 font-17">
                                <a href="{{route('vendor',$seller->id)}}">{{$seller->insta_logo}}</a>
                                @if($seller->shopCategory != null)
                                <ul class="list-unstyled text-center pt-0 mt-0">
                                    <!--<li class="inlineblock">دسته بندی:</li>-->
                                    <li class="inlineblock">{{\Illuminate\Support\Str::limit($seller->shopCategory->title,15)}}</li>
                                </ul>
                                    @endif
                            </div>
                            <div class="action text-center">
