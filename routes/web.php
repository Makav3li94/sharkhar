...
Route::post( '/forget/password', [ \App\Http\Controllers\SellersController::class, 'forgetPassword' ] )->name( 'forget_password' );
Route::get( '/sharkhar/login', [ \App\Http\Controllers\Auth\LoginController::class, 'showAdminLoginForm' ] )->name( 'admin_login' );
Route::get( '/login/buyer', [ \App\Http\Controllers\Auth\LoginController::class, 'showBuyerLoginForm' ] )->name( 'login_buyer' );
Route::get( '/link/login/buyer/{token}', [ \App\Http\Controllers\Auth\LoginController::class, 'linkLoginBuyer' ] )->name( 'link_login_buyer' );
Route::get( '/send-pass/', [ \App\Http\Controllers\Auth\LoginController::class, 'sendPass' ] )->name( 'send_pass' );
Route::get( '/register/buyer', [ \App\Http\Controllers\Auth\RegisterController::class, 'showBuyerRegisterForm' ] )->name( 'register_buyer' );
Route::post( '/sharkhar/login', [ \App\Http\Controllers\Auth\LoginController::class, 'adminLogin' ] )->name( 'admin_login' );
Route::post( '/login/buyer', [ \App\Http\Controllers\Auth\LoginController::class, 'buyerLogin' ] )->name( 'buyer_login' );
...
Route::name( 'buyer.' )->prefix( 'buyer' )->middleware( 'auth:buyer' )->group( function () {
	Route::get( 'dashboard', [ \App\Http\Controllers\Admin\Buyer\AdminBuyerController::class, 'dashboard' ] )->name( 'dashboard' );
	Route::get( 'profile/{buyer}', [ \App\Http\Controllers\Admin\Buyer\AdminBuyerController::class, 'profile' ] )->name( 'profile' );
	Route::patch( 'profile/update/{buyer}', [ \App\Http\Controllers\Admin\Buyer\AdminBuyerController::class, 'update' ] )->name( 'update' );
	Route::resource( 'orders', \App\Http\Controllers\OrdersController::class )->except( [ 'create', 'show' ] );;
	Route::resource( 'police', \App\Http\Controllers\PoliceController::class )->except( [ 'create', 'show' ] );;
	Route::resource( 'products', \App\Http\Controllers\ProductsController::class )->except( [ 'create', 'show' ] );;
	Route::resource( 'transactions', \App\Http\Controllers\TransactionsController::class )->only( [ 'index', ] );;
