...
//	$PROXY_PORT = "1723";    // Proxy server port
//	$PROXY_USER = "neo63";    // Username
//	$PROXY_PASS = "19171363";   // Password
//
...
//	);
//
//	$url      = "https://www.instagram.com/gallery_saatkade/?__a=1";
//	$response = file_get_contents( $url );
//
//	return $userdata = json_decode( $response, true );
//	$userdata['logging_page_id'];
